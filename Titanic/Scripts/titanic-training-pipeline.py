...
def g():
    ...
    try: 
        ...
        titanic_fg = fs.get_feature_group(name="titanic_feature_modal", version=1)
        query = titanic_fg.select_all()
        feature_view = fs.create_feature_view(name="titanic_feature_modal",
                                          version=1,
    ...
    df_cm = pd.DataFrame(results, ['True Survivor', 'True Death'],
                         ['Pred Survivor', 'Pred Death'])
